( function($) {
    'use strict';
      ...
      if ($('#pagepiling-service').length > 0){
  
        $('#pagepiling-service').pagepiling({
            scrollingSpeed: 280,
            navigation:false,
            menu: '.navbar-nav',
            anchors: ['services'],
    ...
    if ($('#pagepiling-clients').length > 0){
  
        $('#pagepiling-clients').pagepiling({
            scrollingSpeed: 280,
            navigation:false,
            menu: '.navbar-nav',
            anchors: ['partners'],
    ...
    if ($('#pagepiling-reel').length > 0){
  
        $('#pagepiling-reel').pagepiling({
            scrollingSpeed: 280,
            navigation:false,
            menu: '.navbar-nav',
            anchors: ['reels'],
    ...
    if ($('#pagepiling-social').length > 0){
  
        $('#pagepiling-social').pagepiling({
            scrollingSpeed: 280,
            navigation:false,
            menu: '.navbar-nav',
            anchors: ['contact-form-sec'],
            afterRender: function(anchorLink, index){ 
            NavbarColor();
            },
            afterLoad: function(anchorLink, index){
