!function(t) {
    ...
    t("ul.sf-menu li.current-menu-item").parents("li").addClass("current-menu-item"),
    void 0 !== t.fn.stickySidebar && VLTJS.document.imagesLoaded(function() {
    ...
    "undefined" != typeof AOS && VLTJS.window.on("vlt.site-loaded", e),
    void 0 !== t.fn.fancybox && (t.fancybox.defaults.btnTpl = {
    ...
    t.fancybox.defaults.buttons = ["close"],
    t.fancybox.defaults.infobar = !1,
    t.fancybox.defaults.transitionEffect = "slide")
}(jQuery),
function(t) {
    "use strict";
    VLTJS.submenuEffectStyle1 = {
        ...
        init: function() {
            ...
            var n = t('[data-submenu-effect="style-1"]')
              , s = n.find("ul.sf-menu");
            s.find("ul.sub-menu").prepend('<li class="sub-menu-back"><a href="#">' + s.data("back-text") + "</a></li>"),
            s.on("click", "li.menu-item-has-children > a", function(n) {
                i(!0, t(this).parent()),
                e(t(this)),
                n.preventDefault()
            }),
            s.on("click", "li.sub-menu-back > a", function(n) {
                i(!1, t(this).parent().parent().parent()),
                e(t(this)),
                n.preventDefault()
            })
        }
    ...
    VLTJS.menuCreative = {
        init: function() {
            ...
            n.on("click", function(t) {
                t.preventDefault(),
                e ? (n.removeClass("vlt-menu-burger--opened"),
                VLTJS.menuCreative.close_menu(i)) : (n.addClass("vlt-menu-burger--opened"),
                VLTJS.menuCreative.open_menu(i, s))
            }),
            VLTJS.document.keyup(function(t) {
                27 === t.keyCode && e && (t.preventDefault(),
                VLTJS.menuCreative.close_menu(i))
            })
        },
        open_menu: function(t, i) {
            e = !0,
            t.addClass("is-open"),
            "undefined" != typeof gsap && gsap.fromTo(i, {
                autoAlpha: 0
            }, {
                autoAlpha: 1,
                duration: .3,
    ...
    VLTJS.menuFullscreen = {
        init: function() {
            ...
            n.on("click", function(t) {
                t.preventDefault(),
                e ? (n.removeClass("vlt-menu-burger--opened"),
                VLTJS.menuFullscreen.close_menu(i)) : (n.addClass("vlt-menu-burger--opened"),
                VLTJS.menuFullscreen.open_menu(i, s))
            }),
            VLTJS.document.keyup(function(t) {
                27 === t.keyCode && e && (t.preventDefault(),
                VLTJS.menuFullscreen.close_menu(i))
            })
        },
        open_menu: function(t, i) {
            e = !0,
    ...
    if (void 0 !== t.fn.superclick) {
        ...
        VLTJS.menuMobile = {
            init: function() {
                ...
                n.on("click", function(t) {
                    t.preventDefault(),
                    e ? VLTJS.menuMobile.close_menu(i, n) : VLTJS.menuMobile.open_menu(i, n)
                }),
                VLTJS.document.keyup(function(t) {
                    27 === t.keyCode && (t.preventDefault(),
                    VLTJS.menuMobile.close_menu(i, n))
                })
            },
            open_menu: function(t, i) {
                t.slideDown(),
                i.addClass("vlt-menu-burger--opened"),
                VLTJS.html.css(overflow, "hidden"),
                e = !0
            },
            close_menu: function(t, i) {
                t.slideUp(),
                i.removeClass("vlt-menu-burger--opened"),
...
function(t) {
    ...
    VLTJS.menuOffcanvas = {
        ...
        init: function() {
            ...
            n.on("click", function(t) {
                t.preventDefault(),
                e ? VLTJS.menuOffcanvas.close_menu(n, i, a) : VLTJS.menuOffcanvas.open_menu(n, i, s, a)
            }),
            VLTJS.document.keyup(function(t) {
                27 === t.keyCode && e && (t.preventDefault(),
                VLTJS.menuOffcanvas.close_menu(n, i, a))
            }),
            a.on("click", function() {
        ...
        open_menu: function(t, i, n, s) {
            e = !0,
            t.addClass("vlt-menu-burger--opened"),
            i.addClass("is-open"),
            "undefined" != typeof gsap && gsap.timeline({
                defaults: {
        ...
        close_menu: function(t, i, n) {
            e = !1,
            t.removeClass("vlt-menu-burger--opened"),
...
function(t) {
    ...
    VLTJS.menuSlide = {
        ...
        init: function() {
            ...
            n.on("click", function(t) {
                t.preventDefault(),
                e ? VLTJS.menuSlide.close_menu(n, i, a) : VLTJS.menuSlide.open_menu(n, i, s, a)
            }),
            VLTJS.document.keyup(function(t) {
                27 === t.keyCode && e && (t.preventDefault(),
                VLTJS.menuSlide.close_menu(n, i, a))
            }),
            a.on("click", function() {
    ...
    VLTJS.devideSection = {
        init: function() {
            t(".vlt-devide-section").each(function() {
                var e = t(this)
                  , i = e.outerHeight() / 2;
                e.find(">div").css("margin-top", -i),
                e.closest("section").css("margin-top", i)
            })
        }
    },
        ...
        init: function() {
            t(".vlt-devide-element").each(function() {
                var e = t(this)
                  , i = e.outerHeight() / 2;
                e.find(">div").css("margin-top", -i),
                e.hasClass("reset-mobile") && VLTJS.window.outerWidth() <= 768 && e.find(">div").css("margin-top", "")
            })
        }
    },
...
function(t) {
    ...
    function n() {
        t(".vlt-hover-reveal").remove(),
        t("[data-tooltip-image]").each(function(e) {
            function i(t) {
            ...
            VLTJS.body.append('<div class="vlt-hover-reveal"><div class="vlt-hover-reveal__inner"><div class="vlt-hover-reveal__img" style="background-image: url(' + l.data("tooltip-image") + ');"></div></div></div>'),
            c && VLTJS.body.find(".vlt-hover-reveal").css({
                width: c[0] + "px",
                height: c[1] + "px"
            });
    ...
    VLTJS.document.on("vlt-ajax-load-more", function(t) {
        i(),
        e(),
        n()
    })
...
function(t) {
    ...
    void 0 !== t.fn.scrollTo && t('a[href^="#"]').not('[href="#"]').on("click", function(e) {
        e.preventDefault(),
        VLTJS.html.scrollTo(t(this).attr("href"), 500)
    })
}(jQuery),
function(t) {
    "use strict";
    ...
    VLTJS.searchPopup = {
        ...
        init: function() {
            ...
            n.on("click", function(t) {
                t.preventDefault(),
                e || VLTJS.searchPopup.open_search(i, a)
            }),
            s.on("click", function(t) {
                t.preventDefault(),
                e && VLTJS.searchPopup.close_search(i, a)
            }),
            ...
            VLTJS.document.keyup(function(t) {
                27 === t.keyCode && e && (t.preventDefault(),
                VLTJS.searchPopup.close_search(i, a))
            })
        },
...
function(t) {
    ...
    VLTJS.stickyNavbar = {
        init: function() {
            function e() {
                s.addClass("vlt-navbar--fixed"),
                o.show()
            }
            function i() {
                s.removeClass("vlt-navbar--fixed"),
                o.hide()
            }
            function n() {
            ...
            s.hasClass("vlt-navbar--sticky") && (VLTJS.window.on("scroll resize", n),
            n(),
            s.after(o),
            ...
            VLTJS.throttleScroll(function(t, e) {
                ...
                "down" === t && e > 450 ? n() : "up" !== t && "end" !== t && "start" !== t || i(),
                s.hasClass("vlt-navbar--transparent") && s.hasClass("vlt-navbar--sticky") && (e > a ? s.addClass("vlt-navbar--solid") : s.removeClass("vlt-navbar--solid"))
            })
        }
    },
        ...
        init: function() {
            ...
            t(".vlt-stretch-block").each(function() {
                var i = t(this)
                  , n = i.offset().left
                  , s = i.outerWidth();
                i.hasClass("to-left") && i.find(">*").css("margin-left", -n),
                i.hasClass("to-right") && i.find(">*").css("margin-right", n + s - e),
                i.hasClass("reset-mobile") && VLTJS.window.outerWidth() <= 768 && i.find(">*").css({
                    "margin-left": "",
                    "margin-right": ""
                })
            })
...
function(t) {
    ...
    VLTJS.button = {
        init: function() {
            t(".vlt-btn").find("span").length || t(".vlt-btn").append("<span>"),
            t(".vlt-btn").on("mouseenter", function(e) {
                var i = t(this)
                  , n = i.offset()
                  , s = e.pageX - n.left
                  , a = e.pageY - n.top;
            ...
            if (e.length) {
                ...
                n.on("init slideChange", function() {
                    var s = t(i)
                      ...
                      , o = (a + 1) / r;
                    "vertical" == s.data("direction") ? (s.find(".current").text(VLTJS.addLedingZero(a + 1)),
                    s.find(".total").text(VLTJS.addLedingZero(r))) : (s.find(".current").text(a + 1),
                    s.find(".total").text(r)),
                    s.find(".bar > span").css({
                        "--scaleX": o,
            ...
            "undefined" != typeof Swiper && t(".vlt-content-slider").each(function() {
                ...
                f.on("init slideChange", function() {
                    var i = t(n)
                      ...
                      , r = (s + 1) / a;
                    "vertical" == i.data("direction") ? (i.find(".current").text(VLTJS.addLedingZero(s + 1)),
                    i.find(".total").text(VLTJS.addLedingZero(a))) : (i.find(".current").text(s + 1),
                    i.find(".total").text(a)),
                    i.find(".bar > span").css({
                        "--scaleX": r,
        ...
        init: function(e) {
            void 0 !== t.fn.countdown && t(".vlt-countdown").each(function() {
                ...
                e.countdown(i, function(t) {
                    e.find("[data-days]").html(t.strftime("%D")),
                    e.find("[data-hours]").html(t.strftime("%H")),
                    e.find("[data-minutes]").html(t.strftime("%M")),
                    e.find("[data-seconds]").html(t.strftime("%S"))
                })
            })
        }
    },
    ...
    VLTJS.projectShowcase3 = {
        init: function() {
            ...
            if (e.length) {
                ...
                n.init(),
                e.on("click", ".vlt-project-showcase__next-slide a", function(t) {
                    t.preventDefault(),
                    n.slideNext()
                })
            }
        ...
        init: function() {
            ...
            if (e.length) {
                ...
                n.on("init slideChange", function() {
                    ...
                    case "light":
                        t(".vlt-navbar").hasClass("vlt-navbar--white-text-on-top") && t(".vlt-navbar").removeClass("vlt-navbar--white-text-on-top"),
                        t(".vlt-site-fixed-bar").hasClass("has-white-color") && t(".vlt-site-fixed-bar").removeClass("has-white-color");
                        break;
                    case "dark":
                        t(".vlt-navbar").hasClass("vlt-navbar--white-text-on-top") || t(".vlt-navbar").addClass("vlt-navbar--white-text-on-top"),
                        t(".vlt-site-fixed-bar").hasClass("has-white-color") || t(".vlt-site-fixed-bar").addClass("has-white-color")
                    }
                }),
                n.on("init slideChange", function() {
                    var s = t(i)
            ...
            if (i.length) {
                ...
                s.on("init slideChange", function() {
                    var e = t(n)
                      ...
                      , o = (a + 1) / r;
                    "vertical" == e.data("direction") ? (e.find(".current").text(VLTJS.addLedingZero(a + 1)),
                    e.find(".total").text(VLTJS.addLedingZero(r))) : (e.find(".current").text(a + 1),
                    e.find(".total").text(r)),
                    e.find(".bar > span").css({
                        "--scaleX": o,
            ...
            if (e.length) {
                ...
                s.on("init slideChange", function() {
                    var n = t(i)
                      ...
                      , r = e.find(".swiper-slide").not(".swiper-slide-duplicate").length
                      , o = (a + 1) / r;
                    "vertical" == n.data("direction") ? (n.find(".current").text(VLTJS.addLedingZero(a + 1)),
                    n.find(".total").text(VLTJS.addLedingZero(r))) : (n.find(".current").text(a + 1),
                    n.find(".total").text(r)),
                    n.find(".bar > span").css({
                        "--scaleX": o,
                        "--speed": s.params.speed + "ms"
    ...
    VLTJS.tabs = {
        init: function() {
            ...
            e.on("mouseenter", "li", function() {
                ...
                e.find("li").removeClass("is-active"),
                n.addClass("is-active"),
                i.eq(s).addClass("is-active")
            })
        }
    },
    VLTJS.tabs.init()
    ...
    VLTJS.typesList = {
        init: function() {
            ...
            i.on("mouseenter", function() {
                ...
                VLTJS.typesList.add_opacity(n),
                VLTJS.typesList.current_background(i, s)
